// Clean test data creation for Client 3
...
async function createTestData() {
 ...
 roadmapId = roadmapResult[0].id;
        ...
        // 5. Create risks - skipping for now due to enum issues
        console.log('⚠️ Skipping risk assessments due to enum issues...');

        // 6. Create controls - skipping due to schema issues
        console.log('🛡️ Skipping controls due to schema issues...');
        ...
        console.log('• Tasks: 5 implementation tasks');
