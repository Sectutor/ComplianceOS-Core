...
export default function Notifications() {
  ...
  const { data: settings, isLoading: settingsLoading } = trpc.notifications.getSettings.useQuery(undefined, { staleTime: 60_000, keepPreviousData: true });
  const { data: logs, isLoading: logsLoading } = trpc.notifications.getLogs.useQuery({ limit: 20 }, { staleTime: 60_000, keepPreviousData: true });
  ...
  const [formState, setFormState] = useState({
    ...
    overdueEnabled: 1,
    dailyDigestEnabled: 0,
    weeklyDigestEnabled: 1,
    notifyControlReviews: 1,
    notifyPolicyRenewals: 1,
    notifyEvidenceExpiration: 1,
  });
  ...
  useEffect(() => {
    if (settings) {
      setFormState({
        ...
        upcomingReviewDays: settings.upcomingReviewDays,
  ...
  const handleToggle = (key: keyof typeof formState) => {
    const newValue = formState[key] === 1 ? 0 : 1;
  ...
  const handleDaysChange = (value: string) => {
    ...
    updateSettings.mutate({ upcomingReviewDays: days });
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="emailEnabled"
                  checked={formState.emailEnabled === 1}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="overdueEnabled"
                  checked={formState.overdueEnabled === 1}
                  onCheckedChange={() => handleToggle('overdueEnabled')}
                  disabled={formDisabled || formState.emailEnabled === 0}
                />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="dailyDigest"
                  checked={formState.dailyDigestEnabled === 1}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="weeklyDigest"
                  checked={formState.weeklyDigestEnabled === 1}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="controlReviews"
                  checked={formState.notifyControlReviews === 1}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="policyRenewals"
                  checked={formState.notifyPolicyRenewals === 1}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  checked={formState.notifyEvidenceExpiration === 1}
